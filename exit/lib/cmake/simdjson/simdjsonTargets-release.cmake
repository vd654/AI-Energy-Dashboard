...
set_target_properties(simdjson::simdjson PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libsimdjson.25.0.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libsimdjson.25.dylib"
  )

list(APPEND _cmake_import_check_targets simdjson::simdjson )
list(APPEND _cmake_import_check_files_for_simdjson::simdjson "${_IMPORT_PREFIX}/lib/libsimdjson.25.0.0.dylib" )
