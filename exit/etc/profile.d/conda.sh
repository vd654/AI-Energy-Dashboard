export CONDA_EXE='/Users/vanessadungl/Desktop/AI-Energy-Dashboard/exit/bin/conda'
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE='/Users/vanessadungl/Desktop/AI-Energy-Dashboard/exit/bin/python'
