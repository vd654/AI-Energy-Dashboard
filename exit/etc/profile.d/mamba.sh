echo "WARNING: /Users/vanessadungl/Desktop/AI-Energy-Dashboard/exit/etc/profile.d/mamba.sh (the file emitting this warning) is deprecated."
...
if [ -z "" ]; then
    ...
    echo "WARNING: "
    echo "WARNING: For now, we are setting 'MAMBA_ROOT_PREFIX' to '/Users/vanessadungl/Desktop/AI-Energy-Dashboard/exit'."
    echo "WARNING: "
    ...
    echo "WARNING: "
    echo "WARNING: This message originates from /Users/vanessadungl/Desktop/AI-Energy-Dashboard/exit/etc/profile.d/mamba.sh"
    export MAMBA_ROOT_PREFIX="/Users/vanessadungl/Desktop/AI-Energy-Dashboard/exit"
fi

__mamba_setup="$("/Users/vanessadungl/Desktop/AI-Energy-Dashboard/exit/bin/mamba" shell hook --shell posix 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__mamba_setup"
else
    alias mamba="/Users/vanessadungl/Desktop/AI-Energy-Dashboard/exit/bin/mamba"  # Fallback on help from mamba activate
fi
unset __mamba_setup
